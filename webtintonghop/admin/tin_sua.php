...
<body>
   ...
   <div class="tab-content">
      ...
      <div class="col-10 m-auto" >
         <h2 class="py-2 text-center h4 ">CHỈNH SỬA TIN</h2>
         <form action="" method="post">
            <div class="mb-3">
                  <label>Tên đề tin</label>
                  <input class="form-control bg-light" type="text" name="TieuDe" value="<?= $result[0]['TieuDe']??"" ?>">
            </div>
            <div class="mb-3">
                  <label>Mô tả tin</label>
                  <textarea name="TomTat" class="form-control bg-light"><?= $result[0]['TomTat']??"" ?></textarea>
            </div>
            <div class="mb-3">
                  <label>Địa chỉ hình</label>
                  <input class="form-control bg-light" type="text" name="urlHinh" value="<?= $result[0]['urlHinh']??"" ?>">
            </div>
            <div class="mb-3">
                  <label>Ngày đăng</label>
                  <input class="form-control bg-light" type="date" name="Ngay" value="<?= $result[0]['Ngay']??"" ?>">
            </div>
            <div class="mb-3">
               ...
               <select name="idLT"class="form-control bg-light">
                  ...
                  foreach ($listLT as $item) {
                     if ($item['idLT'] == $result[0]['idLT'])
                     echo "<option selected value='$item[idLT]' > $item[Ten] </option>";
                     else
                     echo "<option value='$item[idLT]' > $item[Ten] </option>";
                  }
                  ?>
               </select>
            </div>
            <div class="mb-3">
               ...
               &nbsp; &nbsp; &nbsp; &nbsp; 
               <b>Ngôn ngữ:</b>
               <input type="radio" name="lang" value="vi" <?= ($result[0]['lang']=='vi')? "checked":"" ?> > Việt Nam
               <input type="radio" name="lang" value="en" <?= ($result[0]['lang']=='en')? "checked":"" ?> > English
               &nbsp; &nbsp; &nbsp; &nbsp; 
               <b>Nổi bật: </b>
               <input type="radio" name="NoiBat" value="1" <?= ($result[0]['NoiBat']==1)? "checked":"" ?> > Tin nổi bật
               <input type="radio" name="NoiBat" value="0" <?= ($result[0]['NoiBat']==0)? "checked":"" ?> > Tin thường
            </div>    
            <div class="mb-3">
            <textarea name="Content" id="Content" class="form-control"><?= $result[0]['Content']??"" ?></textarea>
            </div>        
            <div class="mb-3">
